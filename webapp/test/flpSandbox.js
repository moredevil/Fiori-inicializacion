		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#experisdemoinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"experisdemoinvoices-display": {
								"semanticObject": "experisdemoinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=experisdemo.invoices",
									"url": sap.ui.require.toUrl("experisdemo/invoices")
								}
							}
						}
					}
